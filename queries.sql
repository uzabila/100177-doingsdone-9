...
VALUES
	...
	('2019-04-07 10:46:00', NULL, 'Купить корм для кота', '0','/?task=4', 4, 3),
...
SELECT name FROM projects_cat WHERE user_id = 1;

SELECT t.name, pc.name FROM tasks t
JOIN projects_cat pc ON t.user_id = pc.user_id;
